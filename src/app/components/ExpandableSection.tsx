...
export function ExpandableSection({
  ...
  const toneMap = {
    emerald:
      "border-emerald-100 bg-emerald-50/80 text-emerald-700 dark:border-emerald-500/35 dark:bg-emerald-950/60 dark:text-emerald-200",
    indigo:
      "border-indigo-100 bg-indigo-50/80 text-indigo-700 dark:border-indigo-500/35 dark:bg-indigo-950/60 dark:text-indigo-200",
    amber:
      "border-amber-100 bg-amber-50/80 text-amber-700 dark:border-amber-500/35 dark:bg-amber-950/60 dark:text-amber-200",
    ...
    yellow:
      "border-yellow-100 bg-yellow-50/80 text-yellow-700 dark:border-yellow-500/35 dark:bg-yellow-950/60 dark:text-yellow-200",
  ...
  return (
    <section
      className={`overflow-hidden rounded-[1.4rem] border border-stone-200 bg-white shadow-sm dark:border-stone-800 dark:bg-stone-950 ${className}`}
    >
      <div className="flex items-start justify-between gap-3 p-3.5 sm:p-4">
        ...
        >
          <span
            className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border shadow-sm ${tone && Icon ? toneMap[tone] : "border-stone-200 bg-stone-50 text-stone-600"}`}
          >
            {Icon ? (
          ...
          <span className="min-w-0 flex-1">
            <span className="block break-words text-[15px] font-semibold text-stone-950 dark:text-white sm:text-base">
              {title}
            </span>
            {summary ? (
              <span className="mt-0.5 line-clamp-2 block break-words text-xs leading-snug text-stone-500 dark:text-stone-300 sm:text-sm">
                {summary}
              </span>
            ) : null}
          </span>
