...
type NewRow<T extends RowShape> = Partial<T>;
  ...
  public: {
    Tables: {
      ...
      household_members: TableDef<
        HouseholdMember,
        NewRow<HouseholdMember>,
        PatchRow<HouseholdMember>
      >;
      cards: TableDef<Card, NewRow<Card>, PatchRow<Card>>;
      household_finance_state: TableDef<
        HouseholdFinanceState,
        HouseholdFinanceState,
        PatchRow<HouseholdFinanceState>
      >;
      monthly_snapshots: TableDef<
        MonthlySnapshot,
        NewRow<MonthlySnapshot>,
        PatchRow<MonthlySnapshot>
      >;
      ...
      fixed_expense_monthly_values: TableDef<
        FixedExpenseMonthlyValue,
        NewRow<FixedExpenseMonthlyValue>,
        PatchRow<FixedExpenseMonthlyValue>
      >;
      ...
      goal_progress_rows: TableDef<
        GoalProgressRow,
        NewRow<GoalProgressRow>,
        PatchRow<GoalProgressRow>
      >;
      financial_commitments: TableDef<
        FinancialCommitment,
        NewRow<FinancialCommitment>,
        PatchRow<FinancialCommitment>
      >;
    };
